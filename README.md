...
1. Add the Instagram usernames that you wish to add to your feed to a file "accounts.sh". You can comment out any line with the "#" symbol, so I recommend structuring your "accounts.sh" file with headers. For a simplistic example, see the section below.
